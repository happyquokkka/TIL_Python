...
# 각 원소를 인덱스를 통해 접근 - 원소의 값을 확인하기 위함임
for i in range(0, len(ints)) :   # 0부터 ints 리스트 내 원소의 개수까지
    print(ints[i])

# 인덱스를 통해 원소에 접근
print(numbers[3])   # [10,20,30] 출력된다 (numbers 리스트의 4번째 원소 출력된 것)
